                    ...
                    <div className="space-y-6">
                     ...
                     <div className="py-8 border border-white/[0.08] rounded-2xl text-center mb-6">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                          <span className="px-5 py-2.5 bg-[#FFCC00]/10 border border-[#FFCC00]/20 text-[#FFCC00] rounded-xl font-bold text-sm">MTN MoMo</span>
                          <span className="px-5 py-2.5 bg-red-500/10 border border-red-500/20 text-red-500 rounded-xl font-bold text-sm">Airtel Money</span>
                          <span className="px-5 py-2.5 bg-[#FF6600]/10 border border-[#FF6600]/20 text-[#FF6600] rounded-xl font-bold text-sm">Orange Money</span>
                          <span className="px-5 py-2.5 bg-green-500/10 border border-green-500/20 text-green-500 rounded-xl font-bold text-sm">M-Pesa</span>
                        </div>
                     </div>
                  ) : (
